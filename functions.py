...
def transcribe_audio(audio_input_file_path):
    ...
    """
    https://chatgpt.com/c/68bd71e2-7bb8-8321-82ac-fa4a1a0b8a0e
    ID of the model to use. The options are gpt-4o-transcribe, 
    gpt-4o-mini-transcribe, and whisper-1 (which is powered by our open source Whisper V2 model).　
    """
...
def create_problem_and_play_audio():
    ...
    Text to speech
    For turning text into speech, use the Audio API audio/speech endpoint. 
    Models compatible with this endpoint are gpt-4o-mini-tts, tts-1, 
    and tts-1-hd. With gpt-4o-mini-tts, you can ask the model to speak a certain way or with a certain tone of voice.
    """
